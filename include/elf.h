...
{
    u16 version;  /* Version of flags structure                  */
    u8 isa_level; /* The level of the ISA: 1-5, 32, 64           */
    u8 isa_rev;   /* The revision of ISA:                        */
                  /*   - 0 for MIPS V and below,                 */
                  /*   - 1-n otherwise.                          */
    u8 gpr_size;  /* The size of general purpose registers       */
    u8 cpr1_size; /* The size of co-processor 1 registers        */
    u8 cpr2_size; /* The size of co-processor 2 registers        */
    u8 fp_abi;    /* The floating-point ABI                      */
    u32 isa_ext;  /* Mask of processor-specific extensions       */
    u32 ases;     /* Mask of ASEs used                           */
    u32 flags1;   /* Mask of general flags                       */
    u32 flags2;
